...
namespace web_1
{
    public partial class ElderlyInfo : System.Web.UI.Page
    {
        ...
        protected void BindGridView2()//gridview fall
        {
            MySqlConnection connection = new MySqlConnection(connectionString);
            connection.Open();
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)//長者詳細資料
        {
            ...
            if (e.CommandName == "Details")
            {
                ...
                eId_Lebel.Text = selectedRow.Cells[1].Text;
                eName_Text.Text = selectedRow.Cells[2].Text;
                ...
                eIdCard_Text.Text = selectedRow.Cells[5].Text;
                ePhone_Text.Text = selectedRow.Cells[6].Text;
                eAddress_Text.Text = selectedRow.Cells[7].Text;
                eHeight_Text.Text = selectedRow.Cells[8].Text;
                eWeight_Text.Text = selectedRow.Cells[9].Text;
                string dateString2 = selectedRow.Cells[4].Text;
                DateTime birthDate2;
                ...
                pId_Text.Text = selectedRow.Cells[11].Text;
                cId_Text.Text = selectedRow.Cells[12].Text;
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        else
                        {
                            ...
                            //Label1.Visible = true;
                            //Label1.Text = "新增成功";
                            query = "INSERT INTO Elder (eId,eName,eIdCard,eGender,eBirth,ePhone,eAddress,eHeight,eWeight,eCreateFile,cId,pId) VALUES (@eId,@eName,@eIdCard,@eGender,@eBirth,@ePhone,@eAddress,@eHeight,@eWeight,@eCreateFile,@cId,@pId)";
                            connection = new MySqlConnection(connectionString);
                            command = new MySqlCommand(query, connection);
                            connection.Open();

                            command.Parameters.AddWithValue("@eId", eId_Text.Text);
                            command.Parameters.AddWithValue("@eName", eName_Text.Text);
                            command.Parameters.AddWithValue("@eIdCard", eIdCard_Text.Text);
                            command.Parameters.AddWithValue("@eGender", eGender_list.Text);
                            command.Parameters.AddWithValue("@eBirth", eBirth_Text.Text);
                            ...
                            command.Parameters.AddWithValue("@eHeight", eHeight_Text.Text);
                            command.Parameters.AddWithValue("@eWeight", eWeight_Text.Text);
                            command.Parameters.AddWithValue("@eCreateFile", currentDate.ToString("yyyy-MM-dd HH:mm:ss"));
                            command.Parameters.AddWithValue("@pId", pId_list.SelectedValue);
                            command.Parameters.AddWithValue("@cId", cId_list.SelectedValue);
